...
data class Coordinate(
    ...
    @ColumnInfo(name = "uesdd_es") val uesddes: String = "",
    @ColumnInfo(name = "zav_num_esdd") val znesdd: String = "",
    @ColumnInfo(name = "uts_pipe_2") val utsPipe2: String = "",
    @ColumnInfo(name = "upp_pipe_2") val uppPipe2: String = "",
    @ColumnInfo(name = "ipol_ve_pipe_2") val ipolPipe2: String = "",
    @ColumnInfo(name = "uesdd_es_2") val uesddes2: String = "",
    @ColumnInfo(name = "zav_num_esdd_2") val znesdd2: String = "",
